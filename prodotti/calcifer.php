...
<div class="content">
    <div class="top">
        ...
        <span class="subtitle">Fintech P2P Lending Ecosystem & Full-Stack API RESTful Architecture</span>
    </div>
    <div class="bottom">
        <span class="text">
